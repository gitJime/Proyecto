...
import bgImage from '../Images/imagen5.jpg'; // Importa la imagen de fondo
            ...
            >
                <div className="contenedor">
                    <div className="formulario">
                        ...
                        <button className="button-google" style={{ width: '80%', marginBottom: '20px' }}>Iniciar con Google</button>
                        ...
                        <div>
                            <button className="button" style={{ width: '80%' }}>Acceder</button>
                        </div>
                    </div>
                </div>
